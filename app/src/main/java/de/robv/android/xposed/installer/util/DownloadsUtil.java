...
public class DownloadsUtil {
    ...
    private static class DownloadDialog extends MaterialDialog {
        ...
        public DownloadDialog(Builder builder) {
            super(builder);
            mProgress = (ProgressBar) builder.build().findViewById(android.R.id.progress);
            mProgressLabel = (TextView) builder.build().findViewById(R.id.md_label);
            mProgressMinMax = (TextView) builder.build().findViewById(R.id.md_minMax);
        }
